...
```
docker run --rm -ti -v /home/$USER/RNAcmap_data/database/:/nt_database -v /home/$USER/RNAcmap_data/:/mnt jaswindersingh2/rnacmap:latest RNAcmap mnt/seq1.fasta RNAfold GREMLIN
```
